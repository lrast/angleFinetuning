...
def InitialSweep_TrainDistributionAndNoise():
    ...
    def sweepRun():
        ...
        runEarlyStoppingTraining(model, 
                                 directory=f'trainedParameters/initialSweepResults/{dirName}')
...
def dataFile_initialSweep(kappa_tr, loc_tr, noiseVar, 
    ...
    dataDirectory = 'trainedParameters/initialSweepResults/' + \
                            str(hash((kappa_tr, loc_tr, noiseVar, pixelDim, reps,
                                shotNoise)))[1:]
